...
#ifndef AEROBOT_INTERFACES__SRV__DETAIL__ESC_SRV__FUNCTIONS_H_
#define AEROBOT_INTERFACES__SRV__DETAIL__ESC_SRV__FUNCTIONS_H_
...
/// Create srv/EscSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aerobot_interfaces__srv__EscSrv_Request__init().
...
/// Destroy srv/EscSrv message.
/**
 * It calls
 * aerobot_interfaces__srv__EscSrv_Request__fini()
...
/// Check for srv/EscSrv message equality.
/**
...
/// Initialize array of srv/EscSrv messages.
/**
...
/// Finalize array of srv/EscSrv messages.
/**
 * It calls
 * aerobot_interfaces__srv__EscSrv_Request__fini()
...
/// Create array of srv/EscSrv messages.
/**
 * It allocates the memory for the array and calls
 * aerobot_interfaces__srv__EscSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/EscSrv messages.
/**
 * It calls
 * aerobot_interfaces__srv__EscSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/EscSrv message array equality.
/**
...
/// Copy an array of srv/EscSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aerobot_interfaces__srv__EscSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aerobot_interfaces
...
/**
 * It calls
 * aerobot_interfaces__srv__EscSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aerobot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * aerobot_interfaces__srv__EscSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aerobot_interfaces
...
/**
 * It calls
 * aerobot_interfaces__srv__EscSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AEROBOT_INTERFACES__SRV__DETAIL__ESC_SRV__FUNCTIONS_H_
