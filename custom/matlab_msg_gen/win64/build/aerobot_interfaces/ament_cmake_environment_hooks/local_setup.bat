...
set "AMENT_ENVIRONMENT_HOOKS[aerobot_interfaces]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[aerobot_interfaces] "%AMENT_CURRENT_PREFIX%\share\aerobot_interfaces\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[aerobot_interfaces] "%AMENT_CURRENT_PREFIX%\share\aerobot_interfaces\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[aerobot_interfaces]:;=";"%") do (
    call:call_file %%f
  )
